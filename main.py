...
def parse_args():
    ...
    parser.add_argument('--task', type=str, default='VA', choices=['VA', 'EXPR', 'AU'],
                        help='Specify the task (VA, EXPR, AU).')
    parser.add_argument('--feature', nargs='+', default=['vggface2'], 
    ...
    parser.add_argument('--root', type=str, default='/userdata/anliuwei/Aff-Wild2/',
...
def main(args):
    ...
    args.feat_dim = train_dataset.get_feature_dim()
